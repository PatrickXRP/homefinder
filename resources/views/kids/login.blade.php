...
<body class="flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <p class="text-white/70 text-center mb-4 text-lg">Wie ben jij?</p>

        {{-- QR code --}}
        <div class="flex justify-center mb-6">
            <div class="bg-white p-3 rounded-2xl cursor-pointer" onclick="this.classList.toggle('scale-150'); this.classList.toggle('z-50'); this.classList.toggle('relative');" title="Tik om te vergroten">
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=180x180&data={{ urlencode('https://homefinder.voidos.nl/kids') }}&bgcolor=ffffff&color=1a3d2b" alt="QR Code" width="180" height="180" class="rounded-lg">
            </div>
        </div>
        <p class="text-white/40 text-center text-xs mb-6">Scan met je tablet om deze pagina te openen</p>
